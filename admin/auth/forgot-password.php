...
<head>
    ...
    <title>Forgot Password - Rentertain</title>
...
<body>
    <div class="admin-login-container admin-auth-forgot">
        <!-- Left Panel - Branding -->
        ...
        <div class="admin-form-panel">
            ...
            <div class="admin-mobile-hero">
                ...
                <p>Answer the security questions to verify your identity and reset your admin password.</p>
            </div>
